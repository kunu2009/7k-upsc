...
const InterviewPrepSection: React.FC = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto p-4">
            <h2 className="text-3xl font-bold mb-2 text-center text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-emerald-400">Interview Prep</h2>
            <p className="text-slate-400 mb-8 text-center">Commonly asked questions and ideal approaches.</p>
